...
**Weekly Learning Visuals**

Screenshots of week-by-week learning notes are attached. To include them in the repository, add the image files to `Assets/docs/` and embed them in the README. Suggested filenames and example Markdown:

```markdown
![Week-by-week learning — page 1](Assets/docs/weekly-learning-1.png)

![Week-by-week learning — page 2](Assets/docs/weekly-learning-2.png)
```

Suggested filenames: `weekly-learning-1.png`, `weekly-learning-2.png`.
